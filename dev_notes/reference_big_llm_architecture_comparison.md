...
Source: https://magazine.sebastianraschka.com/p/the-big-llm-architecture-comparison (Sebastian Raschka)
...
<img src="https://substackcdn.com/image/fetch/$s_!iCn-!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4ae4aa85-3e22-486c-9bd9-27edc4acbf8b_3000x2093.png" />

<figcaption>Figure 1: A subset of the architectures covered in this article.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!uVhV!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F647caf83-cd3d-46f8-8bd0-0946bd896ea1_1023x474.png" />

<figcaption><em>Figure 2: A comparison between MHA and GQA. Here, the group size is 2, where a key and value pair is shared among 2 queries.</em></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!jagJ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Feb9a75be-2848-4b99-af3d-4c48bdd0181a_1550x858.png" />

<figcaption><em>Figure 3: Comparison between MLA (used in DeepSeek V3 and R1) and regular MHA.</em></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!efDX!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2b7e646a-16c1-4245-9a3f-55a41f3070c2_903x856.png" />

<figcaption>Figure 4: Annotated tables from the DeepSeek-V2 paper, https://arxiv.org/abs/2405.04434</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!d_xI!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F632d3212-432a-4d43-b271-f2269be1d8ec_1304x822.png" />

<figcaption>Figure 5: An illustration of the Mixture-of-Experts (MoE) module in DeepSeek V3/R1 (right) compared to an LLM with a standard FeedForward block (left).</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!i4ms!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3d93c441-a6d2-4257-bd80-2d3590c4001c_1039x569.png" />

<figcaption><em>Figure 6: An annotated figure from "DeepSeekMoE: Towards Ultimate Expert Specialization in Mixture-of-Experts Language Models", https://arxiv.org/abs/2401.06066</em></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!7DYj!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbb5c7281-eded-4319-9ae2-7b07478a86b2_1027x823.png" />

<figcaption>Figure 7: Modeling benchmark performance (higher is better) vs pre-training cost (FLOPs; lower is better) for different LLMs. This is an annotated figure from the OLMo 2 paper, https://arxiv.org/abs/2501.00656</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!wYj9!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F61a4560f-d97f-4c78-a7a3-765babb45bec_1444x789.png" />

<figcaption><em>Figure 8: A comparison of Post-Norm, Pre-Norm, and OLMo 2's flavor of Post-Norm.</em></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!ebW0!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F186190ec-2ae5-430d-b0d4-a63486e0f3fb_1289x407.png" />

<figcaption><em>Figure 9: A plot showing the training stability for Pre-Norm (like in GPT-2, Llama 3, and many others) versus OLMo 2's flavor of Post-Norm. This is an annotated figure from the OLMo 2 paper, https://arxiv.org/abs/2501.00656</em></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!S6Y9!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7fa42974-cfae-45cc-9cd9-fc1d9607d386_1329x737.png" />

<figcaption>Figure 10: An architecture comparison between Llama 3 and OLMo 2.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!LQA4!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb5363ce6-0ec8-49e6-b296-9836c248e159_665x302.png" />

<figcaption><em>Figure 11: An annotated figure from Gemma 3 paper (https://arxiv.org/abs/2503.19786) showing the KV cache memory savings via sliding window attention.</em></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!tTJ5!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff32c2d74-ec34-43ef-86bc-bcce832426b3_1600x792.png" />

<figcaption><em>Figure 12: A comparison between regular attention (left) and sliding window attention (right).</em></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!YSZb!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F788a5023-1ba3-4372-89cd-4ebeff132255_1600x477.png" />

<figcaption>Figure 13: An annotated figure from Gemma 3 paper (https://arxiv.org/abs/2503.19786) showing that sliding window attention has little to no impact on the LLM-generated output perplexity.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!A1BM!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F752ec4b7-2720-44f8-958b-0ca85b3a96f1_1068x855.png" />

<figcaption><em>Figure 14: An architecture comparison between OLMo2 and Gemma 3; note the additional normalization layers in Gemma 3.</em></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!Su7d!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb05999d6-88ca-4739-8b0b-266b48da288b_662x483.png" />

<figcaption>Figure 15: An annotated figure from Google's Gemma 3n blog (https://developers.googleblog.com/en/introducing-gemma-3n/) illustrating the PLE memory savings.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!SdCR!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5140cd93-4e54-4a3d-af74-f8d1b8ea1647_1402x757.png" />

<figcaption>Figure 16: An architecture comparison between Gemma 3 27B and Mistral 3.1 Small 24B.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!ShdO!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F17518ff9-1f60-4aca-b654-034dabe20626_1600x823.png" />

<figcaption>Figure 17: An architecture comparison between DeepSeek V3 (671-billion parameters) and Llama 4 Maverick (400-billion parameters).</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!pu4b!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9d542035-0713-4c71-8d6d-68e0e37bf0c7_1466x925.png" />

<figcaption>Figure 18: An architecture comparison between Qwen3 0.6B and Llama 3 1B; notice that Qwen3 is a deeper architecture with more layers, whereas Llama 3 is a wider architecture with more attention heads.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!6Cx4!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4627dac1-ced7-4e8d-8de4-d9238b1c427d_1632x810.png" />

<figcaption>Figure 19: An architecture comparison between DeepSeek V3 and Qwen3 235B-A22B.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!vPTQ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Febfdfd6e-6aee-4894-8a57-307a25bc2c0a_743x519.png" />

<figcaption><em>Figure 20: An annotated figure from the SmolLM3 announcement post, https://huggingface.co/blog/smollm3, comparing the SmolLM3 win rate to Qwen3 1.7B and 4B as well as Llama 3 3B and Gemma 3 4B.</em></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!oGOS!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff761a811-e394-4ea1-bb80-fbed44f48d89_1447x770.png" />

<figcaption>Figure 21: A side-by-side architecture comparison between Qwen3 4B and SmolLM3 3B.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!lLgK!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd79f412c-269f-4236-9cbe-81f1a5944ae1_1190x548.png" />

<figcaption>Figure 22: A modified figure from my Build A Large Language Model (From Scratch) book (https://www.amazon.com/Build-Large-Language-Model-Scratch/dp/1633437167) illustrating absolute positional embeddings.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!I9j6!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd7a57872-2af0-465b-ab5f-2caecc0aac8f_1364x800.png" />

<figcaption>Figure 23: An annotated figure from the NoPE paper (https://arxiv.org/abs/2305.19466) showing better length generalization with NoPE.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!_Zh8!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F78d5d4e4-7dc4-49ab-87be-a885ba78447e_759x684.png" />

<figcaption>Figure 24: Annotated figures from the Kimi K2 announcement blog article (https://moonshotai.github.io/Kimi-K2/) and the OLMo 2 paper (https://arxiv.org/abs/2305.19466).</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!B3em!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb721c5ef-057b-405b-9293-f11e161d9230_1599x816.png" />

<figcaption>Figure 25.1: An architecture comparison between DeepSeek V3 and Kimi K2.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!q-S4!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd9ee20b3-2ef5-4988-9abc-736bcd20ea51_2200x2200.jpeg" />

<figcaption>Figure 25.2: DeepSeek R1 versus Kimi K2 Thinking architecture (top) and Kimi K2 Thinking benchmarks (bottom).</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!1PO4!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2d438dde-c0f6-4e99-a0a8-b41e11366a27_1631x788.png" />

<figcaption>Figure 26: Architecture overview of the two gpt-oss models.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!eSQG!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc79215d3-891e-431f-af20-8e2a3fa4be10_1552x799.png" />

<figcaption>Figure 27: Architecture comparison between gpt-oss and Qwen3</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!kMwd!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F019ead67-6811-4c9d-af7b-4e6b2563ea68_1046x565.png" />

<figcaption>Figure 28: An annotated figure from "DeepSeekMoE: Towards Ultimate Expert Specialization in Mixture-of-Experts Language Models", https://arxiv.org/abs/2401.06066</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!hfZq!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F15ddb1b6-1540-4889-86c5-c54f5918562e_1221x352.png" />

<figcaption>Figure 29: gpt-oss models use bias units in the attention layers. See code example here.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!vQ5q!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2fa2e161-ba61-43ab-a17b-5e6eab448699_307x151.png" />

<figcaption>Figure 30: Table from https://arxiv.org/pdf/2302.08626 showing the average test loss when the models were trained from scratch with and without bias units.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!xuLx!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F389b83da-f588-4e54-93ca-716d60d7f087_1064x754.png" />

<figcaption><span>Figure 31: The use of attention sinks in gpt-oss; based on the Hugging Face code </span><a href="https://github.com/huggingface/transformers/blame/369c99d0cea403b77bd0aef818527106453fd9fc/src/transformers/models/gpt_oss/modular_gpt_oss.py">here</a><span>.</span></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!3Zgv!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F59c43b82-8214-4def-996f-f22a45fa085c_1683x919.png" />

<figcaption>Figure 32: Grok 2.5 next to a Qwen3 model of comparable size</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!qmQC!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcf489564-f69c-4aa7-b335-0f7d172205c4_4349x3076.jpeg" />

<figcaption>Figure 33: GLM-4.5 benchmark from the official GitHub repository at https://github.com/zai-org/GLM-4.5</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!hFr9!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6bc7588c-88bc-408e-8c71-9190d476149f_2280x1262.png" />

<figcaption>Figure 34: GLM-4.5 next to a similarly-sized Qwen3 model.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!iUTU!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fce674219-3fb4-4c76-b397-408f477ce827_4111x2244.png" />

<figcaption>Figure 35: The original Qwen3 model released in May (left) next to the Qwen3 Next model released in September (right).</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!o36C!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9a248bdb-c1f2-4c7f-861a-1d2921d785e5_8676x3593.png" />

<figcaption><span>Figure 37: MiniMax-M2 benchmark performance compared to other popular open-weight and proprietary LLMs. Image from the official model hub release </span><a href="https://huggingface.co/MiniMaxAI/MiniMax-M2">readme</a><span> file.</span></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!FZo2!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe5c8bd5f-4bef-4a7e-81e0-6b9923b9cfb3_2154x818.png" />

<figcaption>Figure 38: A timeline of the main LLMs covered in this article, next to some of the attention-hybrid models that constitute more efficient alternatives, trading off some modeling performance with improved efficiency.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!9tSa!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc2c47830-113c-4742-a20d-61c65be805ed_2540x1398.png" />

<figcaption>Figure 39: Comparison between Qwen3 and MiniMax-M2.</figcaption>
...
<span style="display:block;">\\\text{Attention}(Q, K, V) = \text{softmax}\\\left(\frac{QK^\top}{\sqrt{d}}\right)V \\</span>
...
<img src="https://substackcdn.com/image/fetch/$s_!fVCN!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2602d095-c73d-4b70-a461-d1e84555d2cb_793x831.png" />

<figcaption><span>Figure 40: Illustration of the quadratic cost in attention due to sequence length </span><em>n</em><span>.</span></figcaption>
...
<span style="display:block;">\\\text{Attention}(Q, K, V) = \text{softmax}\\\left(\frac{QK^\top}{\sqrt{d}}\right)V \approx \phi(Q)\big(\phi(K)^\top V\big)\\</span>
...
<img src="https://substackcdn.com/image/fetch/$s_!8d7L!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7bfd3b82-47f8-4efd-abc9-1e8ae2a1c350_948x362.png" />

<figcaption>Figure 41: An overview of the linear attention hybrid architectures.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!StPn!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3b813eae-03ec-4289-aa18-bde7b7ef887c_2224x1468.png" />

<figcaption>Figure 42: Qwen3-Next and Kimi Linear side by side.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!ZTgh!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb2735736-1197-49d4-8a53-84a0ce178247_718x600.png" />

<figcaption>Figure 43: Annotated figure from the Kimi Linear paper showing that Kimi Linear is as fast as GatedDeltaNet, and much faster than an architecture with multi-head latent attention (like DeepSeek V3/R1), while having a higher benchmark performance.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!-a3F!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbdc2e5a4-ebf8-49a5-bada-e42712d7cff5_7624x4202.png" />

<figcaption>Figure 44: Olmo 3 7B and Qwen3 8B side by side.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!ah3K!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9dc738f6-7d4b-467f-a417-21623af37341_7401x4103.png" />

<figcaption>Figure 45: Olmo 3 32B and Qwen3 32B side by side.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!ASJ0!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1b86a6b8-2810-4106-a6b6-b1279f74cd6a_5000x5000.png" />

<figcaption><span>Figure 46: </span><a href="https://github.com/rasbt/LLMs-from-scratch/blob/main/ch05/13_olmo3/standalone-olmo3.ipynb">Olmo 3 from-scratch implementation</a></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!3k9N!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8e05d2ad-c3f3-4ba3-9f41-6f266fdc385a_2318x778.png" />

<figcaption>Figure 47: A timeline of the DeepSeek model releases since DeepSeek V3. The main models are shown in red.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!0Nu7!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F889af384-7748-4eb7-9caf-1fa332f8ed10_2652x1442.png" />

<figcaption>Figure 48: The DeepSeek model architecture with multi-head latent and sparse attention.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!p-ic!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F95750417-26c3-414d-8d09-4446b281c59f_2116x1198.png" />

<figcaption><span>Figure 49: Mistral 3 Large benchmarks from the </span><a href="https://mistral.ai/news/mistral-3">Mistral 3 announcement</a><span>, with the DeepSeek V3.2 results (from the </span><a href="https://arxiv.org/abs/2512.02556">DeepSeek V3.2 paper</a><span>) overlayed on top of it.</span></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!hyFt!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F991a079d-36d9-433a-befb-f783f7e1df85_2340x1156.png" />

<figcaption>Figure 50: DeepSeek V3 and Mistral 3 Large side by side.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!GkUD!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8cf4dcd3-76ef-43df-92d1-1d0e1832a5de_1596x1562.png" />

<figcaption>Figure 51.1: Outline of the Nemotron 3 Nano model, which is a Transformer-Mamba hybrid.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!csBk!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2416e3bd-8628-42da-b8bc-2cead9970971_2048x1284.png" />

<figcaption><span>Figure 51.2: Multi-Token Prediction versus regular next token prediction. (Left subfigure inspired by the </span><a href="https://arxiv.org/abs/2404.19737">MTP paper</a><span>.) Originally, MTP was only used during training, not inference; hence, the inference time steps (bottom) show a single next-token prediction.</span></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!5eJd!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faf154466-501f-411c-8552-b605ca6c3f20_1862x1656.png" />

<figcaption>Figure 51.3: Nemotron 3 Super 120B-A12B with latent MoE layers, multi-token prediction, and the Mamba-2 hybrid attention approach.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!dA9C!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc5749706-bfd2-4210-a9b0-d1e6f6d7edb8_1858x894.png" />

<figcaption><span>Figure 51.4: Nemotron 3 Super benchmark comparison from the </span><a href="https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-BF16/blob/main/accuracy_chart.png">Hugging Face Hub</a><span> page.</span></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!3OQi!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F83e10345-16d1-4c00-883b-08946c9980a3_2556x1212.png" />

<figcaption>Figure 52: Xiaomi MiMo-V2-Flash compared to DeepSeek V3.2, which has similar benchmark performance.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!Zfu9!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5d18dfdb-dacf-40fb-aae0-937abe96ea12_1512x1556.png" />

<figcaption><span>Figure 53: Overview of the Trinity Large architecture (based on the model hub </span><a href="https://huggingface.co/arcee-ai/Trinity-Large-Preview/blob/main/config.json">config file</a><span>).</span></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!DQdq!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8c156e1e-f414-46bb-aadf-76db5059bdbc_2478x1242.png" />

<figcaption>Figure 54: Arcee AI Trinity Large next to GLM 4.5 of a relatively similar size (400B vs 355B).</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!y7Xt!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcac96315-e4a7-43ec-b48f-158161090a2d_1426x940.png" />

<figcaption>Figure 55: Illustration of the gating mechanism that Trinity Large uses in the attention mechanism.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!UmUH!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd5369a4c-218b-4987-b28f-f36d7e3fa37e_5807x2924.png" />

<figcaption>Figure 56: Architecture of GLM-5 and GLM-4.5 side by side.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!TY2g!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F916c0755-6c9d-4f14-bec5-d0daf9337e00_5680x5821.png" />

<figcaption>Figure 57: GLM architectures next to benchmarks. The GLM-4.7 architecture is similar to GLM-4.5. The benchmarks are taken from the GLM-5 release blog post: https://z.ai/blog/glm-5</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!4ppK!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6e610250-2793-4aa0-8a98-a0acf4a68d7e_1908x942.png" />

<figcaption>Figure 58: Gemma 3 (27B) and Gemma 4 (31B) side by side.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!TDMh!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F208e9bab-a2f8-4e5b-bed0-2db600993c41_4200x2400.png" />

<figcaption><span>Figure 59: Gemma 3 versus Gemma 4 versus Qwen3.5 (the numbers are taken from the </span><a href="https://huggingface.co/google/gemma-4-31B">Gemma 4</a><span> and </span><a href="https://huggingface.co/Qwen/Qwen3.5-27B">Qwen3.5</a><span> model hub pages).</span></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!CFGk!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faffe325a-5dce-4298-96d0-61c7d8f6b673_1828x920.png" />

<figcaption>Figure 60: Qwen3 Coder Flash compared to Gemma 4 MoE.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!NgKc!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F95bfad09-34e9-463d-8a0e-745108c383b6_4050x2400.png" />

<figcaption>Figure 61: Gemma 4 MoE (26B-A4B) is only slightly worse than Gemma 4 (31) dense.</figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!MMT9!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F37068b66-4b13-474c-849b-9224d549a513_3276x2808.webp" />

<figcaption><span>LLM architecture gallery at </span><a href="https://sebastianraschka.com/llm-architecture-gallery/">https://sebastianraschka.com/llm-architecture-gallery/</a></figcaption>
...
<img src="https://substackcdn.com/image/fetch/$s_!RCl_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F27a118a0-5da6-4486-b1f0-3743754d0a77_8106x4044.webp" alt="Build a Large Language Model (From Scratch)" />

<figcaption><em><span>Build a Large Language Model (From Scratch) is now available on </span><a href="https://amzn.to/4fqvn0D">Amazon</a><span>. Build a Reasoning Model (From Scratch) is in </span><a href="https://mng.bz/Nwr7">Early Access at Manning</a><span>.</span></em></figcaption>
