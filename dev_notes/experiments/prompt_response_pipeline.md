...
3. Math (`openr1_math`, 18k/2k, famille LFM2, Teacher déjà précalculé) CE vs KD, puis conditionnellement `openr1_math_full` (35k/3.9k, "5%", plus coûteux -- l'utilisateur a explicitement anticipé qu'il pourrait s'avérer trop gros pour une première expérience).
