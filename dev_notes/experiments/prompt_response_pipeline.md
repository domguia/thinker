...
4bis. **Sweep taille de KB terminé pour `n_docs_max=5`** : answer_ce full-val = **7.8406** (légèrement meilleur que le défaut `n_docs_max=10`'s 7.8643) -- moins de documents distracteurs semble aider marginalement plutôt que nuire, résultat à confirmer avec `n_docs_max=20` (en cours) avant conclusion.
