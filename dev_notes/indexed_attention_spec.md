...
## 14. Intégration d'`Thinker` sur texte réel — vers un objectif LM par position **[PROPOSITION 2026-09-13, pas encore implémentée, design uniquement]**
...
### 14.6 Changements d'interface proposés pour `Thinker.forward`
